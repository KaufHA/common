...
YAML_FILE_TRIGGER_PLF10         = "__KAUF_PLF10_LEGACY_YAML__"
YAML_FILE_TRIGGER_PLF12         = "__KAUF_PLF12_LEGACY_YAML__"
YAML_FILE_TRIGGER_PLF10_PLUS    = "__KAUF_PLF10_PLUS_LEGACY_YAML__"
YAML_FILE_TRIGGER_PLF12_PLUS    = "__KAUF_PLF12_PLUS_LEGACY_YAML__"
YAML_FILE_TRIGGER_PLF10_MINIMAL = "__KAUF_PLF10_MINIMAL_LEGACY_YAML__"
YAML_FILE_TRIGGER_PLF12_MINIMAL = "__KAUF_PLF12_MINIMAL_LEGACY_YAML__"
...
def _validate_yaml_file(value):
    ...
    # Added: 2026-09-21. Switch to cv.Invalid after 2027-03-21. Delete branches after 2027-09-21.
        ...
        LOGGER.warning(
            "\n"
            "============================================================\n"
            "PLF10/kauf-plug.yaml is deprecated. Please migrate by updating\n"
            "your yaml file:\n"
            "\n"
            "---- CHANGE THIS: ----\n"
            "packages:\n"
            ...
            "---- TO THIS: ----\n"
            "packages:\n"
            "  Kauf.PLF10: github://KaufHA/kauf-plugs/packages/kauf-plf10-lite.yaml\n"
            "\n"
            "See: https://github.com/KaufHA/kauf-plugs#profile-options\n"
            "============================================================"
        )
    elif value == YAML_FILE_TRIGGER_PLF12:
        LOGGER.warning(
            "\n"
            "============================================================\n"
            "PLF12/kauf-plf12.yaml is deprecated. Please migrate by updating\n"
            "your yaml file:\n"
            "\n"
            "---- CHANGE THIS: ----\n"
            "packages:\n"
            ...
            "---- TO THIS: ----\n"
            "packages:\n"
            "  Kauf.PLF12: github://KaufHA/kauf-plugs/packages/kauf-plf12-lite.yaml\n"
            "\n"
            "See: https://github.com/KaufHA/kauf-plugs#profile-options\n"
            "============================================================"
        )
    elif value == YAML_FILE_TRIGGER_PLF10_PLUS:
        LOGGER.warning(
            "\n"
            "============================================================\n"
            "PLF10/config/kauf-plug-plus.yaml is deprecated. Please migrate\n"
            "by updating your yaml file:\n"
            "\n"
            "---- CHANGE THIS: ----\n"
            "packages:\n"
            "  Kauf.PLF10: github://KaufHA/PLF10/config/kauf-plug-plus.yaml\n"
            "\n"
            "---- TO THIS: ----\n"
            "packages:\n"
            "  Kauf.PLF10: github://KaufHA/kauf-plugs/packages/kauf-plf10.yaml\n"
            "\n"
            "See: https://github.com/KaufHA/kauf-plugs#profile-options\n"
            "============================================================"
        )
    elif value == YAML_FILE_TRIGGER_PLF12_PLUS:
        LOGGER.warning(
            "\n"
            "============================================================\n"
            "PLF12/config/kauf-plf12-plus.yaml is deprecated. Please migrate\n"
            "by updating your yaml file:\n"
            "\n"
            "---- CHANGE THIS: ----\n"
            "packages:\n"
            "  Kauf.PLF12: github://KaufHA/PLF12/config/kauf-plf12-plus.yaml\n"
            "\n"
            "---- TO THIS: ----\n"
            "packages:\n"
            "  Kauf.PLF12: github://KaufHA/kauf-plugs/packages/kauf-plf12.yaml\n"
            "\n"
            "See: https://github.com/KaufHA/kauf-plugs#profile-options\n"
            "============================================================"
        )
    elif value == YAML_FILE_TRIGGER_PLF10_MINIMAL:
        LOGGER.warning(
            "\n"
            "============================================================\n"
            "PLF10/config/kauf-plug-minimal.yaml is deprecated. Please\n"
            "migrate by updating your yaml file:\n"
            "\n"
            "---- CHANGE THIS: ----\n"
            "packages:\n"
            "  Kauf.PLF10: github://KaufHA/PLF10/config/kauf-plug-minimal.yaml\n"
            "\n"
            "---- TO THIS: ----\n"
            "substitutions:\n"
            "  component_family: stock\n"
            "  profile: minimal\n"
            "  target: plf10\n"
            "\n"
            "packages:\n"
            "  Kauf.PLF10: github://KaufHA/kauf-plugs/packages/kauf-plug.yaml\n"
            "\n"
            "See: https://github.com/KaufHA/kauf-plugs#profile-options\n"
            "============================================================"
        )
    elif value == YAML_FILE_TRIGGER_PLF12_MINIMAL:
        LOGGER.warning(
            "\n"
            "============================================================\n"
            "PLF12/config/kauf-plf12-minimal.yaml is deprecated. Please\n"
            "migrate by updating your yaml file:\n"
            "\n"
            "---- CHANGE THIS: ----\n"
            "packages:\n"
            "  Kauf.PLF12: github://KaufHA/PLF12/config/kauf-plf12-minimal.yaml\n"
            "\n"
            "---- TO THIS: ----\n"
            "substitutions:\n"
            "  component_family: stock\n"
            ...
            "\n"
            "packages:\n"
            "  Kauf.PLF12: github://KaufHA/kauf-plugs/packages/kauf-plug.yaml\n"
            "\n"
            "See: https://github.com/KaufHA/kauf-plugs#profile-options\n"
            "============================================================"
        )
