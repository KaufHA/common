...
void WebServer::handle_index_request(AsyncWebServerRequest *request) {
  ...
  if ( strcmp(ESPHOME_PROJECT_NAME,"kauf.rgbww") == 0 ) {
  ...
  else if ( strcmp(ESPHOME_PROJECT_NAME,"kauf.plf10") == 0 ) {
    ...
    stream->print(F("<p><a href=\"https://kaufha.com\" target=\"_blank\" rel=\"noopener noreferrer\">Kaufman Home Automation</a></p>"));
  }
